...
tag-dashboard-fold-title = Duplicati maiuscole/minuscole (alta confidenza)
tag-dashboard-bilingual-title = Equivalenti EN / TR
tag-dashboard-fuzzy-title = Fuzzy (attenzione — concetti padre/figlio)
