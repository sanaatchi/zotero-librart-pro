...
| --- | ---------------------- | ---------------------- | ----- | ----- |
| 1   | Yükle / enable         | Menü, tercihler        |       |       |
| 2   | İkinci pencere         | Observer tek; menü var |       |       |
| 3   | Reader aç/kapat        | Sızıntı yok            |       |       |
| 4   | Pref toggle            | Belgelenen davranış    |       |       |
| 5   | Locale TR/EN           | Ham Fluent ID yok      |       |       |
